            ...
            <div class="site-social-icons-wrapper">
                <div class="site-social-icons">
                    <ul>
                        ...
                        if ( isset($houzz) && !empty($houzz) ) echo('<li><a href="' . $houzz . '" target="_blank" class="social_media"><i class="fa fa-houzz"></i></a></li>' );
                        if ( isset($naver) && !empty($naver) ) echo('<li><a href="' . $naver . '" target="_blank" class="social_media"><i class="spk-icon-naver-line-logo"></i></a></li>' );
                        if ( isset($tripadvisor ) && !empty($tripadvisor)) echo('<li><a href="' . $tripadvisor . '" target="_blank" class="social_media"><i class="fa fa-tripadvisor"></i></a></li>' );
                        if ( isset($wechat ) && !empty($wechat)) echo('<li><a href="' . $wechat . '" target="_blank" class="social_media"><i class="fa fa-weixin"></i></a></li>' );
